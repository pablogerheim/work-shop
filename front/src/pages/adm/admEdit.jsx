import {
  Radio, RadioGroup, Stack, Input, Textarea, Box, Button,
...
function AdmEdit({ id }) {
  ...
  async function handleSubmit() {
    ...
    const active = togleActive === '1';
    const autoexplan = togleautoexplan === '1';
    await productUpdate({
      name, image, description, url, active, autoexplan, productId,
    });
